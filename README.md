...
<p align="center">
    <img src="https://render.githubusercontent.com/render/math?mathgamma({\bf h}) = \frac{1}{2}Var[Z({\bf x %2B h}) - Z({\bf x})] =                                         \frac{1}{2}E\{[Z({\bf x %2B \bf h}) - Z({\bf x})]^{2}\}}#gh-light-mode-only">
